...
const hoverOpcaoConfig: Ref<keyof ComponentsConfiguracaoPage | null> =
  ref("usuarios");
    ...
    <div class="configuracao-frame">
      <div class="opcoes-configuracao">
        <div class="d-flex flex-column" style="height: 100%">
          ...
          <div id="config-opt">
            <ul
              class="list-group list-group-flush border-bottom scrollarea mb-2"
            >
              <BListGroupItem
                :active="
                  hoverOpcaoConfig === 'usuarios' ||
              ...
              <BListGroupItem
                :active="
                  hoverOpcaoConfig === 'credenciais' ||
                  currentConfig === 'credenciais'
                "
